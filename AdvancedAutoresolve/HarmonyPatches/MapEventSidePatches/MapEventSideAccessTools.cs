...
namespace AdvancedAutoResolve.HarmonyPatches.MapEventSidePatches
{
    internal static class MapEventSideAccessTools
    {
        ...
        private static readonly FieldRef<MapEventSide, Dictionary<UniqueTroopDescriptor, MapEventParty>> _allocatedTroops = FieldRefAccess<MapEventSide, Dictionary<UniqueTroopDescriptor, MapEventParty>>("_allocatedTroops");
